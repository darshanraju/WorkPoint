...
export default function Header() {
  return (
    <section className="dark:text-white dark:bg-gray-900 w-full">
      <div className="px-4 py-20 mx-auto lg:items-center lg:flex">
        <div className=" mx-auto text-center w-full">
          ...
          <h1 className="text-4xl md:text-[4rem] font-extrabold text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 w-full">

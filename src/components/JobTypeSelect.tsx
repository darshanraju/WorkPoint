          ...
          <>
            <div className="cursor-pointer relative mt-1">
              ...
              <Transition
                ...
                leaveTo="opacity-0"
              >
                <Listbox.Options className="cursor-pointer dark:bg-[#212e4b] absolute z-10 mt-1 max-h-60 w-full rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
